...
public class PageController {
    ...
    public String viewTask(Model model) {
        // Здесь можно добавить логику для получения списка всех задач
        List<RecentTask> allTasks = new ArrayList<>(); // Получите все задачи из базы данных
        model.addAttribute("allTasks", allTasks); // Добавляем список задач в модель
